...
(* Accepts only a list [1,2,1,2,1,2] *)
fun match xs =
...
(* 
code above works with the native and constructor to define mutual recursive function
below we can simulate the native behaviour
 *)
...
fun no_zeros_or_empty_strings_t2_alternate x =
    case x of
      ...
      | Quuz y => no_zeros_or_empty_strings_t1_alternate(
                    no_zeros_or_empty_strings_t2_alternate,
                    y)
